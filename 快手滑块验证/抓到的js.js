(function() {
    ...
    mt = {},
    c = {
        id: "86a27b7db2c5c0ae37fee4a8a35033ee",
        dm: ["kuaishou.com", "gifshow.com", "kwai.com", "chenzhongtech.com"],
    ...
    mt.lang.G = function(a, b) {
        ...
        else for (var d = 0; d < a.length; d++) if (a[d] === b) {
            g = u;
            break
        }
        return g
    ...
    mt.url.ua = function(a) {
        ...
        mt.f.sa = function(a) {
            ...
            try {
                ...
                for (var d = a.split(">"), e = document.body, b = d.length - 1; 0 <= b; b--) if ( - 1 < d[b].indexOf("#")) {
                    var f = d[b].split("#")[1]; (e = document.getElementById(f)) || (e = document.getElementById(decodeURIComponent(f)));
                ...
                for (a = 0; e && a < d.length;) {
                    ...
                    if (! ("html" === m || "body" === m)) {
                        ...
                        for (s = 0; s < e.childNodes.length; s++) 1 === e.childNodes[s].nodeType && e.childNodes[s].nodeName.toLowerCase() === m && f.push(e.childNodes[s]);
                        if (!f[b]) return v;
                        e = f[b]
                    }
                    a++
        ...
        mt.f.ua = function(a, d) {
            ...
            for (; a.parentNode != v;) {
                for (var f = 0,
                m = 0,
                p = a.parentNode.childNodes.length,
                s = 0; s < p; s++) {
                ...
                if ((p = "" !== a.id) && d) {
                    ...
                    break
                } else p && (p = "#" + encodeURIComponent(a.id), p = 0 < b.length ? p + ">" + b.join(">") : p, l.push(p)),
        ...
        mt.f.getAttribute = function(a, d) {
            ...
            if (!b && a.attributes && a.attributes.length) for (var l = a.attributes,
            f = l.length,
            m = 0; m < f; m++) l[m].nodeName === d && (b = l[m].nodeValue);
            return b
        };
        mt.f.T = function(a) {
            var d = "document";
        ...
        mt.f.S = function(g, d) {
            ...
            return String(e || "").substring(0, 255)
        }; (function() { (mt.f.cb = function() {
                function a() {
                    if (!a.ea) {
                        a.ea = u;
                        for (var d = 0,
                        b = l.length; d < b; d++) l[d]()
                    }
                }
                function d() {
                    try {
                ...
                document.addEventListener ? f = function() {
                    ...
                    else if (document.addEventListener) document.addEventListener("DOMContentLoaded", f, w),
        ...
        return function(d) {
            ...
            default:
                ...
                if (d instanceof Array) {
                    ...
                    m,
                    p;
                    for (m = 0; m < g; m++) switch (p = d[m], typeof p) {
                    case "undefined":
                    case "function":
                    case "unknown":
                        break;
                ...
                f = ["{"];
                m = mt.o.stringify;
                for (g in d) if (Object.prototype.hasOwnProperty.call(d, g)) switch (p = d[g], typeof p) {
                case "undefined":
                case "unknown":
                case "function":
                    break;
    ...
    mt.localStorage.set = function(a, b, g) {
        ...
        try {
            window.localStorage ? (b = d.getTime() + "|" + b, window.localStorage.setItem(a, b)) : mt.localStorage.la() && (mt.localStorage.l.expires = d.toUTCString(), mt.localStorage.l.load(document.location.hostname), mt.localStorage.l.setAttribute(a, b), mt.localStorage.l.save(document.location.hostname))
        } catch(e) {}
    };
    ...
    h.D = {
        ...
        function a(a, d) {
            ...
            b.d(d, "Function") && (e.readyState ? e.onreadystatechange = function() {
                if ("loaded" === e.readyState || "complete" === e.readyState) e.onreadystatechange = v,
                d()
            }: e.onload = function() {
                d()
            });
        ...
        d = {
            ...
            R: function() {
                ...
                b = 0,
                f = c.dm.length; b < f; b++) if (d.W(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[/ ? #]. * /,"");return a},ca:function(){for(var a=0,b=c.dm.length;a<b;a++){var f=c.dm[a];if(-1<f.indexOf("/")&&d.fa(document.location.href,f))return f.replace(/^[^/]+(\/.*)/,"$1 ")+" / "}return" / "}};return h.pa=d})();
                ...
                (function() {
                    function a(a, b, d, f) {
                        if (! (a === r || b === r || f === r)) {
                            ...
                            a = String(a).split("!");
                            for (var e, g = w,
                            k = 0; k < a.length; k++) if (e = a[k].split("*"), String(b) === e[0]) {
                                e[1] = d;
                                e[2] = f;
                                a[k] = e.join("*");
                                g = u;
                    ...
                    k = {
                        ...
                        Ab: function() {
                            if (0 < k.Y.length) for (var a = 0,
                            b = k.Y.length; a < b; a++) k.Ga(k.Y[a]);
                            k.Y = v
                        },
                        Ga: function(a) {
                            var b = a[0];
                        ...
                        _setAutoPageview: function(a) {
                            if (1 < a.length && (a = a[1], w === a || u === a)) k.j |= 2,
                            h.c.Ua = a
                        },
                        ...
                        _trackEvent: function(a) {
                            2 < a.length && (k.j |= 8, h.c.b.nv = 0, h.c.b.st = 4, h.c.b.et = 4, h.c.b.ep = d.h(a[1]) + "*" + d.h(a[2]) + (a[3] ? "*" + d.h(a[3]) : "") + (a[4] ? "*" + d.h(a[4]) : ""), h.c.b.p = y(q.wa()), h.c.i(), h.c.b.p = "")
                        },
                        ...
                        _setReferrerOverride: function(a) {
                            1 < a.length && (h.c.b.su = a[1].charAt && "/" === a[1].charAt(0) ? f.protocol + "//" + window.location.host + a[1] : a[1], k.Xa = u)
                        },
                        ...
                        _setAutoEventTracking: function(a) {
                            if (1 < a.length && (a = a[1], w === a || u === a)) h.c.V = a
                        },
                        _trackPageDuration: function(a) {
                            1 < a.length ? (a = a[1], 2 === String(a).split(",").length && (h.c.b.et = 3, h.c.b.ep = a, h.c.i())) : m.K("duration-send");
                            m.K("duration-done")
                        },
                        _require: function(a) {
                            1 < a.length && (a = a[1], f.rb.test(g.L(a)) && s(a))
                        },
                        _providePlugin: function(a) {
                            if (1 < a.length) {
                                ...
                                b.I = b.I || {},
                                b.plugins[e] = a, b.B = b.B || [], a = b.B.slice(), e && a.length && a[0][1] === e)) for (var g = 0,
                                k = a.length; g < k; g++) {
                                    var l = a[g][2] || {};
                                    if (b.plugins[e] && !b.I[e]) b.I[e] = new b.plugins[e](l),
                                    b.B.shift();
                                    else break
                                }
                            }
                        ...
                        _requirePlugin: function(a) {
                            if (1 < a.length) {
                                ...
                                e = a[1],
                                g = a[2] || {};
                                if (d.G(f.ab, e)) if (b.plugins = b.plugins || {},
                                b.I = b.I || {},
                                b.plugins[e] && !b.I[e]) b.I[e] = new b.plugins[e](g);
                                else {
                                    b.B = b.B || [];
                                    for (var g = 0,
                                    l = b.B.length; g < l; g++) if (b.B[g][1] === e) return;
                                    b.B.push(a);
                    ...
                    var a = h.z;
                    c.spa !== r && "1" === String(c.spa) && (window._hmt = window._hmt || [], window._hmt.push(["_requirePlugin", "UrlChangeTracker"]), a.e("pv-b",
                    function() {
                        "" !== window.location.hash && (h.c.b.u = window.location.href)
                    }))
                })(); (function() {
                    function a() {
                        "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = u, this.b = {},
                        this.Va = this.Ua = u, this.V = k.V, this.Oa = e.H(c.aet) && 0 < c.aet.length ? c.aet.split(",") : "", this.za = w, this.init())
                    }
                    var b = mt.url,
                    g = mt.hb,
                    d = mt.Ha,
...
k.Ub)||b.m(a,k.vc)||"";this.b.ci=b.m(a,k.Sb)||b.m(a,k.sc)||"";this.b.cf=b.m(a,k.Xb)||b.m(a,k.uc)||"";this.b.cu=b.m(a,k.Tb)||b.m(a,k.rc)||"";f.bc()&&(this.b.u=window.location.href)},init:function(){try{this.oc(),0===this.b.nv?this.lc():this.Qa(),h.c=this,this.vb(),this.ub(),x.K("pv - b "),this.jc()}catch(a){var b=[];b.push("si = "+c.id);b.push("n = "+encodeURIComponent(a.name));b.push("m = "+encodeURIComponent(a.message));b.push("r = "+encodeURIComponent(document.referrer));g.log(k.Ba+" //"+k.bb+"?"+b.join("&"))}},
                            jc: function() {
                                ...
                                this.Ua ? (this.za = u, this.b.et = 0, this.b.ep = "", this.b.p = y(q.A("pageview")), this.b.vl = f.U() + f.M(), this.i(a), this.b.p = "") : a();
                                this.X = +new Date;
                                q.s("pageview")
                            },
                            i: function(a) {
                                ...
                                if (window.postMessage && window.self !== window.parent) {
                                    ...
                                    function(d) {
                                        if (b.L(d.origin) === k.jb) {
                                            ...
                                            if (RegExp(c.id).test(d.sd || "") && f) a.b.rnd = Math.round(Math.random() * k.Da),
                    ...
                    var B = h.D,
                    C = h.load; c.pt && C([B.protocol, "//ada.baidu.com/phone-tracker/insert_bdtj?sid=", c.pt].join("")); (function() {
                        var a = mt.g,
                        b = mt.lang,
                        g = mt.event,
                        d = mt.o;
                        if ("undefined" !== typeof h.c && (c.med || (!a.Aa || 7 < a.Jb()) && c.cvcc)) {
                            ...
                            t = function(a, g) {
                                ...
                                if (g) {
                                    ...
                                    p = g.getAttribute("id") || "";
                                    f.test(l) ? (k.sn = "mediate", k.snv = l) : b.d(m, "String") && f.test(m) && (k.sn = "wrap", k.snv = m);
                                    k.id = p
                                }
                                h.c.b.et = 86;
                            ...
                            m = {
                                click: function() {
                                    for (var a = [], b = p(document.getElementsByTagName("a")), b = [].concat.apply(b, p(document.getElementsByTagName("area"))), b = [].concat.apply(b, p(document.getElementsByTagName("img"))), d, e, g = 0, k = b.length; g < k; g++) d = b[g],
                                ...
                                m = {
                                    click: function() {
                                        for (var a = [], b = p(document.getElementsByTagName("a")), b = [].concat.apply(b, p(document.getElementsByTagName("area"))), b = [].concat.apply(b, p(document.getElementsByTagName("img"))), d, e, g, k = 0, l = b.length; k < l; k++) d = b[k],
                                        f !== r ? (e = d.getAttribute("onclick"), g = d.getAttribute("href"), q ? (d = d.getAttribute("id"), (f.test(e) || f.test(g) || q.test(d)) && a.push(b[k])) : (f.test(e) || f.test(g)) && a.push(b[k])) : q !== r && (d = d.getAttribute("id"), q.test(d) && a.push(b[k]));
                                        return a
                                    }
                                }
                            }
                            if ("undefined" !== typeof m && "undefined" !== typeof f) {
                                ...
                                l += /\/$/.test(l) ? "": "/";
                                var k = function(a, d) {
                                    if (y === d) return t(l + a, d),
                                    w;
                                    if (b.d(d, "Array") || b.d(d, "NodeList")) for (var e = 0,
                                    f = d.length; e < f; e++) if (y === d[e]) return t(l + a + "/" + (e + 1), d[e]),
                                    w
                                };
                                g.e(document, "mousedown",
                                function(a) {
                                    a = a || window.event;
                        ...
                        if ("undefined" !== typeof h.c && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
                            var e = {
                                nb: function() {
                                    ...
                                    d, m = 0; m < b; m++)(d = a.Ra(decodeURIComponent(c.cvcf[m]))) && g.e(d, "click", e.ra())
                                },
                                ra: function() {
                                    return function() {
                                        h.c.b.et = 86;
